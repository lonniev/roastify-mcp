...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "## For people\n"
        "There is a web app at https://roastify-app.pages.dev — the Design Bench. "
        "It reads a design's exported .json in the browser to show which layers "
        "can be changed and where each one prints on the box.\n\n"
        "## Pricing\n"
